    ...
    function listar()
    {
        ...
        try {
            $qry = "SELECT lc.id, lc.idusuario, lc.idcaixa, lc.dataemissao,
                ...
                WHERE lc.situacao = 'N' AND lc.sigla_origem = 'CP' 
    ...
    function view($id)
    {
        ...
        try {
            $qry = "SELECT lc.id, lc.idusuario, lc.idcaixa, lc.dataemissao,
                ...
                WHERE lc.situacao = 'N' AND lc.sigla_origem = 'CP' AND lc.id = '$id'";
            $stmt = $this->conexao->prepare($qry);
            $stmt->execute();
    ...
    function contaTotalCaixa()
    {
        ...
        try {
            $qry = "SELECT COUNT(*) AS totalCP FROM lancamentoscaixa
                WHERE situacao = 'S' AND sigla_origem = 'CP'";
            $stmt = $this->conexao->prepare($qry);
            $stmt->execute();
