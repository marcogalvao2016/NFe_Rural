...
class MenuModel extends Model
{
    ...
    function listar()
    {
        ...
        try {
            $qry = "SELECT * FROM crt_menu ORDER BY descricao";
    ...
    function partial($qt)
    {
        ...
        try {
            $qry = "SELECT * FROM crt_menu ORDER BY descricao DESC LIMIT " . $qt;
            $stmt = $this->conexao->prepare($qry);
            $stmt->execute();
            ...
            foreach ($results as $row) {
                $data[] = [
                    ...
                    "request" => [
                        "type" => "GET",
                        "description" => "Retorna todos os registros",
                        "url" => "api/menus/listar/partial/{id}",
                    ]
                ];
            }
        } catch (\Exception $e) {
    ...
    function pesquisar($texto)
    {
        ...
        try {
            $qry = "SELECT * FROM crt_menu WHERE descricao like '%" . $texto . "%' 
    ...
    function view($id)
    {
        ...
        try {
            $qry = "SELECT * FROM crt_menu WHERE id = '$id'";
            $stmt = $this->conexao->prepare($qry);
            $stmt->execute();
    ...
    function deletar($id)
    {
        ...
        try {
            $qry = "DELETE FROM crt_menu WHERE id = '$id'";
            $stmt = $this->conexao->prepare($qry);
            $stmt->execute();
