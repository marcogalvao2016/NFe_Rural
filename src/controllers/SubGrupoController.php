...
class SubGrupoController extends Controller
{
    ...
    {
        $dados = new SubGrupoModel();
        $data = $dados->listar();

        echo json_encode($data, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES | JSON_PRETTY_PRINT);
    }

    public function listarPorGrupo($args)
    {
        $id_grupo = $args['id'];

        $dados = new SubGrupoModel();
        $data = $dados->listarPorGrupo($id_grupo);
    ...
    public function editAction()
    {
        ...
        $id_grupo = intval($requestData['id_grupo']);
